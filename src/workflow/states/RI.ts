...
export const riConfig = {
  ...
  legalRequirementsSummary:
    "Rhode Island closings customarily involve a real estate attorney to prepare the deed and conduct the title search, though not legally mandated. Sellers must complete a Residential Property Disclosure Form. Lead paint disclosure is strictly enforced in Rhode Island.",
  steps: [
    {
      id: "offer_submitted",
