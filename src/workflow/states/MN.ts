...
export const mnConfig = {
  ...
  legalRequirementsSummary:
    "Minnesota closings are handled by a title company. Attorneys are not required. Sellers must provide a Seller's Property Disclosure form. Minnesota has a unique Dual Agency regulation and requires specific well and septic disclosure.",
  steps: [
    {
      id: "offer_submitted",
