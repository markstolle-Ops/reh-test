...
export const waConfig = {
  ...
  legalRequirementsSummary:
    "Washington state closings are handled by a title company or escrow officer. Attorneys are not required. Sellers must complete a Seller Disclosure Statement. Washington requires disclosure of earthquake risk in seismic hazard zones and proximity to industrial zones.",
  steps: [
    {
      id: "offer_submitted",
