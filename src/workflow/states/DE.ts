...
export const deConfig = {
  ...
  legalRequirementsSummary:
    "Delaware requires a licensed attorney to handle the closing, prepare the deed, and conduct the title search. Sellers must complete a Seller's Disclosure of Real Property Condition Report disclosing known material defects.",
  steps: [
    {
      id: "offer_submitted",
