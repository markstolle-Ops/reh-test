...
export const kyConfig = {
  ...
  legalRequirementsSummary:
    "Kentucky closings are typically handled by a title company. Attorneys are not required but commonly used. Sellers must complete a Seller's Disclosure of Property Condition form disclosing known material defects.",
  steps: [
    {
      id: "offer_submitted",
