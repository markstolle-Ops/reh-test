...
export const wyConfig = {
  ...
  legalRequirementsSummary:
    "Wyoming closings are handled by a title company. Attorneys are not required. Sellers must complete a Seller's Property Disclosure form. Mineral rights and surface rights are often separated in Wyoming and require specific disclosure.",
  steps: [
    {
      id: "offer_submitted",
