...
export const ohConfig = {
  ...
  legalRequirementsSummary:
    "Ohio closings are handled by title companies or settlement agents. While attorneys are not legally required, Ohio sellers must complete a Residential Property Disclosure Form. Ohio has a specific timing requirement for the disclosure to be provided to buyers.",
  steps: [
    {
      id: "offer_submitted",
