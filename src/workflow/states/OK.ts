...
export const okConfig = {
  ...
  legalRequirementsSummary:
    "Oklahoma closings are handled by a title company or attorney. Attorneys are not required. Sellers must complete an Oklahoma Residential Property Condition Disclosure Statement. Termite and wood-destroying insect inspection reports are commonly required.",
  steps: [
    {
      id: "offer_submitted",
