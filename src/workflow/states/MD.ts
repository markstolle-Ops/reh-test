...
export const mdConfig = {
  ...
  legalRequirementsSummary:
    "Maryland closings are handled by a title company or settlement agent. Attorneys are not required. Sellers must complete a Residential Property Disclosure and Disclaimer Statement. Maryland requires disclosure of lien payoff amounts.",
  steps: [
    {
      id: "offer_submitted",
