...
export const txConfig = {
  ...
  legalRequirementsSummary:
    "Texas closings are conducted by a licensed title company. Attorneys are not required but may be engaged by either party. Texas uses promulgated TREC contract forms which are mandatory for most residential transactions.",
  steps: [
    {
      id: "offer_submitted",
    ...
    },
    {
      ...
      label: "Option Period / Inspection",
