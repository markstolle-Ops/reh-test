...
export const arConfig = {
  ...
  legalRequirementsSummary:
    "Arkansas closings are typically handled by a title company or attorney. Sellers are required to complete a Residential Property Disclosure Form disclosing known material defects.",
  steps: [
    {
      id: "offer_submitted",
