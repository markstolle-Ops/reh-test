...
export const tnConfig = {
  ...
  legalRequirementsSummary:
    "Tennessee closings are handled by a title company or attorney. Attorneys are not required. Sellers must complete a Tennessee Residential Property Condition Disclosure form. Termite inspection is strongly recommended in Tennessee.",
  steps: [
    {
      id: "offer_submitted",
