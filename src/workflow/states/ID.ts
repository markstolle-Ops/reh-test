...
export const idConfig = {
  ...
  legalRequirementsSummary:
    "Idaho closings are handled by a title company or escrow agent. Attorneys are not required. Sellers must complete a Seller's Property Condition Disclosure Form and disclose all known material defects.",
  steps: [
    {
      id: "offer_submitted",
