...
export const laConfig = {
  ...
  legalRequirementsSummary:
    "Louisiana closings are handled by a title company or notary public (who must be an attorney or notary). Sellers must provide a Property Disclosure document. Louisiana uses a unique civil law system; the Act of Sale is notarized instead of recorded.",
  steps: [
    {
      id: "offer_submitted",
