...
export const moConfig = {
  ...
  legalRequirementsSummary:
    "Missouri closings are handled by a title company or attorney. Attorneys are not required. Sellers must complete a Missouri Seller's Disclosure Statement. Missouri requires lead paint disclosure for pre-1978 properties.",
  steps: [
    {
      id: "offer_submitted",
