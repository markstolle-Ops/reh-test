...
export const nmConfig = {
  ...
  legalRequirementsSummary:
    "New Mexico closings are handled by a title company. Attorneys are not required. Sellers must complete a New Mexico Seller's Property Disclosure Statement. New Mexico requires disclosure of any known defects in the property, including water rights issues.",
  steps: [
    {
      id: "offer_submitted",
