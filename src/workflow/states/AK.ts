...
export const akConfig = {
  ...
  legalRequirementsSummary:
    "Alaska closings are handled by a title company or escrow officer. Attorneys are not required. Sellers must provide a written disclosure of known material defects.",
  steps: [
    {
      id: "offer_submitted",
