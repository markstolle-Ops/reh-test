...
export const orConfig = {
  ...
  legalRequirementsSummary:
    "Oregon closings are handled by a title company or escrow officer. Attorneys are not required. Sellers must complete an Oregon Seller's Property Disclosure Statement. Oregon requires earthquake risk disclosure for certain geographic regions.",
  steps: [
    {
      id: "offer_submitted",
