...
export const wiConfig = {
  ...
  legalRequirementsSummary:
    "Wisconsin closings are handled by a title company or closing agent. Attorneys are not required. Sellers must complete a Seller's Real Estate Condition Report disclosing known defects. Wisconsin requires well and septic system disclosure in rural areas.",
  steps: [
    {
      id: "offer_submitted",
