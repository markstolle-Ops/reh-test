...
export const iaConfig = {
  ...
  legalRequirementsSummary:
    "Iowa closings are typically handled by a title company or attorney. Sellers must complete the Iowa Residential Property Seller Disclosure form and disclose all known material defects affecting the property.",
  steps: [
    {
      id: "offer_submitted",
