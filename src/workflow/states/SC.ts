...
export const scConfig = {
  ...
  legalRequirementsSummary:
    "South Carolina law requires a licensed real estate attorney to close the transaction and certify title. The closing attorney also handles escrow funds. Sellers must complete a Residential Property Condition Disclosure Statement.",
  steps: [
    {
      id: "offer_submitted",
