...
export const neConfig = {
  ...
  legalRequirementsSummary:
    "Nebraska closings are handled by a title company. Attorneys are not required. Sellers must complete a Seller's Property Condition Disclosure. Nebraska requires disclosure of any known defects in structure, systems, or environmental hazards.",
  steps: [
    {
      id: "offer_submitted",
