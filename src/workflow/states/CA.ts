...
export const caConfig = {
  ...
  legalRequirementsSummary:
    "California closings are handled by a licensed title company or escrow company. Attorneys are not required. California requires a Natural Hazard Disclosure report and Transfer Disclosure Statement from sellers.",
  steps: [
    {
      id: "offer_submitted",
