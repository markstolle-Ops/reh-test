...
export const ndConfig = {
  ...
  legalRequirementsSummary:
    "North Dakota closings are handled by a title company. Attorneys are not required. Sellers must complete a North Dakota Seller's Property Disclosure form. Radon disclosure is encouraged given North Dakota's elevated radon levels.",
  steps: [
    {
      id: "offer_submitted",
