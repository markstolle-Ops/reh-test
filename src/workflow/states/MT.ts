...
export const mtConfig = {
  ...
  legalRequirementsSummary:
    "Montana closings are handled by a title company. Attorneys are not required. Sellers must complete a Seller's Property Disclosure form. Montana has significant radon risk and requires radon disclosure in transactions.",
  steps: [
    {
      id: "offer_submitted",
