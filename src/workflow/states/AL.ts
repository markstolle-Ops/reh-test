...
export const alConfig = {
  ...
  legalRequirementsSummary:
    "Alabama closings are typically handled by a title company or attorney. While attorney use is customary, it is not legally required. Sellers must disclose known material defects under Alabama law.",
  steps: [
    {
      id: "offer_submitted",
