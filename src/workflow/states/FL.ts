...
export const flConfig = {
  ...
  legalRequirementsSummary:
    "Florida closings are handled by title companies or closing agents. Attorneys are not required by law. Florida requires sellers to disclose all known material defects and has specific radon and lead-based paint disclosure requirements.",
  steps: [
    {
      id: "offer_submitted",
