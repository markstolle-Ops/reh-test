...
export const miConfig = {
  ...
  legalRequirementsSummary:
    "Michigan closings are handled by a title company or attorney. Attorneys are not legally required. Sellers must complete a Sellers Disclosure Statement. Michigan requires specific septic system disclosure in rural areas.",
  steps: [
    {
      id: "offer_submitted",
