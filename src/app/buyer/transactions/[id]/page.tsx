    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="rounded-lg border border-red-200 bg-red-50 p-6">
          ...
          <Link href="/buyer/dashboard" className="mt-4 inline-block text-sm text-red-600 underline">
            Back to Dashboard
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          <Link href="/buyer/dashboard" className="text-sm text-gray-500 hover:text-gray-700 mb-2 inline-block">
            ← Back to Dashboard
          </Link>
      ...
      {(
        ...
        >
          ...
          <p className="text-sm text-teal-700 mb-4">
            Wire instructions are available for this transaction. You must have
            two-factor authentication enabled to view them.
          </p>
        ...
        >
          <p className="text-sm text-gray-400">
            Secure wire instructions will appear here when closing is scheduled.
            Never send wire funds based on email instructions alone.
          </p>
        </div>
      )}
